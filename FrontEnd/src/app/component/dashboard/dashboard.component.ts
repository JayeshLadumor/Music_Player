...
export class DashboardComponent implements OnInit {
  ...
  myapp = angular.module('myApp', ['mediaPlayer'])
      .service('AuthentService',function ($http) {
                  this.servfunc = function (SongDetails) {
                    console.log("In Serv Function");
      ...
      .controller('mycontroller', function ($scope,AuthentService) {
        //$scope.audio1.setVolume(this.volumelevel*(0.01));
          $scope.xyz = 'Jayesh';
          $scope.number=2;
          $scope.playlist1= [];
          $scope.playlist1 =[
            {src:'../assets/Song_Collection/01 Baarish - Half Girlfriend (Ash King) 190Kbps.mp3',type:'audio/mpeg',name:'01 Baarish - Half Girlfriend (Ash King) 190Kbps.mp3'},
          ...
          $scope.myCallbackFunction= function (newvalue) {
          ...
          $scope.ConvertDownload = function () {
            ...
            AuthentService.servfunc(songdetails);
          };}
          );
