(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/platform-browser'), require('@material-git/core')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', '@angular/platform-browser', '@material-git/core'], factory) :
    (factory((global.md = global.md || {}, global.md.slider = global.md.slider || {}),global.ng.core,global.ng.forms,global.ng.platformBrowser,global.md.core));
}(this, (function (exports,_angular_core,_angular_forms,_angular_platformBrowser,_angular2Material_core) { 'use strict';
...
var SliderRenderer = (function () {
    ...
    SliderRenderer.prototype.updateThumbAndFillPosition = function (percent, width) {
        ...
        _angular2Material_core.applyCssTransform(thumbPositionElement, "translateX(" + position + "px)");
    };
    /**
...
var MdSliderModule = (function () {
    ...
    MdSliderModule = __decorate([
        _angular_core.NgModule({
            ...
            providers: [
                { provide: _angular_platformBrowser.HAMMER_GESTURE_CONFIG, useClass: _angular2Material_core.MdGestureConfig },
            ],
        }), 
